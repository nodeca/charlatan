...
/**
 * Charlatan.Internet.email() -> String
 *
 * Generate email :-)
 *
 ***/
...
/**
 * Charlatan.Internet.freeEmail() -> String
 *
...
/**
 * Charlatan.Internet.safeEmail() -> String
 *
 * Generate email in example.[org|com|net]
 *
 ***/
exports.safeEmail = function(name) {
  var domain = 'example.' + Charlatan.Helpers.sample(['org', 'com', 'net']);
  return this.userName(name).toLowerCase() + '@' + domain;
};


/**
 * Charlatan.Internet.userName(name = null) -> String
...
exports.userName = function(name) {
  var glue = Charlatan.Helpers.sample('.', '_');
  if (!!name) {
