 ...
 **/
exports.postcode = exports.zip = exports.zipCode = function (stateAbbreviation) {
  if (!stateAbbreviation) {
    return Charlatan.bothify(Charlatan.fetch('address.postcode'));
  }

  return Charlatan.bothify(Charlatan.fetch('address.postcode_by_state.' + stateAbbreviation));
};
