...
exports.email = function (name) {
  return exports.userName(name).toLowerCase() + '@' + exports.domainName();
};
...
exports.freeEmail = function (name) {
  return exports.userName(name).toLowerCase() + '@' + Charlatan.fetch('internet.free_email');
};
...
exports.safeEmail = function (name) {
  ...
  return exports.userName(name).toLowerCase() + '@' + domain;
};
...
/**
 * Charlatan.Internet.password([minLength]) -> String
 * - minLength (integer) : min number of characters in password, optional
 *
 * Generate password
 *
 **/
 ...
 *
 * Fetch first level domain such as `com`
 *
 **/
...
// builds slug out of a words array
...
// returns random hex string 64 characters long
