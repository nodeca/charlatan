...
/**
 * Lorem#words(wordCount = 3, supplemental = false) -> Array
...
/**
 * Lorem#sentence(wordCount=null, supplemental=false, capitalize=true) -> String
...
/**
 * Lorem#sentences(sentenceCount, supplemental=false) -> Array
...
exports.paragraph = function(sentenceCount, supplemental){
  ...
  var glue = ' ';
  return this.sentences(sentenceCount, supplemental).join(glue);
};
